(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.kennedi, 400, 550, 6, 0.7);
        collectable.create(type.steve, 100, 450, 3, 1);
        collectable.create(type.db, 350, 600, 7, 1);
        collectable.create(type.grace, 600, 150, 8, 0.8);
